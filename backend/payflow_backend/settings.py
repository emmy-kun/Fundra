"""
Django settings for payflow_backend project.
"""
...
WSGI_APPLICATION = 'payflow_backend.wsgi.application'
...
# PostgreSQL configuration (uncomment to use instead of SQLite)
# DATABASES = {
#     'default': {
